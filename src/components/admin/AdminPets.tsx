...
export const AdminPets = () => {
  ...
  const [activeTab, setActiveTab] = useState<'pets' | 'vaccines'>('pets');
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'vaccines' && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold">Gerenciamento de Vacinas</h3>
                ...
                <Card key={pet.id} className="p-6">
                  ...
                  {petVaccines.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      <h5 className="font-medium text-sm text-muted-foreground">Histórico de Vacinas</h5>
